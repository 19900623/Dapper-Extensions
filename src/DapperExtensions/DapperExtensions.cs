...
namespace DapperExtensions
{
    public static class DapperExtensions
    {
        ...
        public static Page<T> GetPages<T>(this IDbConnection connection, int page = 1, int resultsPerPage = 10, object predicate = null, IList<ISort> sort = null,  IDbTransaction transaction = null, int? commandTimeout = null) where T : class
            => GetPages<T>(connection, null, null, page, resultsPerPage, predicate, sort, transaction, commandTimeout);
        ...
        {
            return Instance.GetPages<T>(connection, predicate, sort, page, resultsPerPage, transaction, commandTimeout, tableName, schemaName);
        }
        public static async Task<Page<T>> GetPagesAsync<T>(this IDbConnection connection, int page = 1, int resultsPerPage = 10, object predicate = null, IList<ISort> sort = null, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
           => await GetPagesAsync<T>(connection, null, null, page, resultsPerPage, predicate, sort, transaction, commandTimeout);
        ...
        {
            return await Instance.GetPagesAsync<T>(connection, predicate, sort, page, resultsPerPage, transaction, commandTimeout, tableName, schemaName);
        }
        #endregion
